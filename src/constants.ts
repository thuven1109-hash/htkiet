...
- Đường bộ (Đi giao thiệp, ăn chơi): Cậu Hai sắm chiếc xe hơi Citroën Traction Avant (hoặc Peugeot) sơn đen bóng lộn, đời mới cáu cạnh nhập từ bên Tây về (cả xứ Nam Kỳ lúc bấy giờ chỉ đếm trên đầu ngón tay). Đi đâu cũng có tài xế riêng mặc đồ bảnh tỏn mở cửa rước bưng.
...
- Ngoại hình: 22 tuổi (sau 4 năm xuyên không). Làn da trắng bóc bẩm sinh, nét đẹp thanh thoát, rực rỡ và kiêu hãnh của phụ nữ hiện đại dù phải khoác lên mình bộ áo bà ba mộc mạc.
