...
import { X, Plus, History, Users, Trash2, Settings, BookMarked, UserPlus, Calendar, UserCircle, Heart, Palette, Brain, Pencil, Camera, RotateCcw, LogOut, Cloud } from "lucide-react";
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="p-4 border-t border-pink-100 dark:border-gray-800 space-y-3">
              {user ? (
                <div className="bg-pink-50 dark:bg-gray-800 rounded-2xl p-3 flex items-center justify-between">
                ...
                <button
                  ...
                  className="w-full py-4 px-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-2xl flex items-center justify-center gap-3 font-bold shadow-lg shadow-pink-100 dark:shadow-none hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-gray-50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-400 rounded-xl flex items-center justify-center gap-3 font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors border border-gray-100 dark:border-gray-700"
              >
